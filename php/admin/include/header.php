    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">HMS Admin</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="<?php if($page == 'customer'){echo 'active';}?>">
                        <a href="customer.php"><i class="fa fa-fw fa-dashboard"></i>Customer</a>
                    </li>
                    ...
                    <li class="<?php if($page == 'payments'){echo 'active';}?>">
                        <a href="payment.php"><i class="fa fa-fw fa-table"></i>Payments</a>
                    </li>
                    <li >
